...
from ...views_utils import PAGINATION_OBJ_COUNT_PER_PAGE
...
class ClientsViewTest(TestCase):
    ...
    def test_list(self):
        ...
        self.assertEqual(response.context['page_obj'].paginator.num_pages, ceil(len(self.clients) /
                         PAGINATION_OBJ_COUNT_PER_PAGE))
